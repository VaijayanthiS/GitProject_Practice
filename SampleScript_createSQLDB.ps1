$resourcegroupname = "lenoraitResourceGroup"
$location = "EastUS"
# Set an admin login and password for your server
$adminlogin = "Vaijayanthi"
$password = "VJsol@123SQL"
# Set server name - the logical server name has to be unique in the system
$servername = "lenoraitsqlservername"
# The sample database name
$databasename = "lenoraitDatabase"
...
$database = New-AzureRmSqlDatabase  -ResourceGroupName $resourcegroupname -ServerName $servername -DatabaseName $databasename -RequestedServiceObjectiveName "S0" -SampleName "AdventureWorksLT" 
